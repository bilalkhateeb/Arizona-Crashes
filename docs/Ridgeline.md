...
if (!document.getElementById("yearSlider")) {
  sliderDiv.innerHTML = `
    <div style="display: flex; align-items: center; justify-content: center; gap: 10px;">
      ...
      <input type="range" id="yearSlider" style="width: 200px; height: 6px; accent-color: #4c8cff; margin: 0;">
...
function createSeparateChart(aggregatedPoints, groupsOrder, customTicks, tickMapping, containerWidth, isAlcohol) {
  ...
  const measures = [
    {
      ...
      stroke: "#d62728",
      yTicks: isAlcohol ? [25, 50, 75, 100] : [100, 200, 300],
    ...
    },
    {
      ...
      stroke: "#FFA500",
      yTicks: isAlcohol ? [250, 500, 750, 1000] : [5000, 10000, 15000],
    ...
    },
    {
      ...
      stroke: "#2ca02c",
      yTicks: isAlcohol ? [500, 1000, 1500] : [10000, 20000, 30000, 40000],
  ...
  measures.forEach((m, i) => {
    ...
    const chart = Plot.plot({
      ...
      height: 150,
      background: "#111",
      marginBottom: i === measures.length - 1 ? 60 : 0,
      marginTop: 20,
      marginLeft: 60,
      marginRight: 40,
      x: {
        label: i === measures.length - 1 ? "Driver Age Group" : null,
...
if (!document.getElementById("toggle")) {
  ...
  document.getElementById("main").insertAdjacentElement("afterbegin", toggleContainer);
}

if (!document.getElementById("slider")) {
  const sliderContainer = document.createElement("div");
  sliderContainer.id = "slider";
  document.getElementById("main").insertAdjacentElement("afterbegin", sliderContainer);
}

if (!document.getElementById("charts")) {
  const chartsContainer = document.createElement("div");
  chartsContainer.id = "charts";
  document.getElementById("main").appendChild(chartsContainer);
} else {
